...
from ssc4frames.newcli.helpers import JsonOption, get_dburl_from_env, get_experiment_hash, get_experiment_runs_from_experiment_config, compare_run_configurations, Metrics, exp_config_equals_db_config, output_results
...
def experiment(ctx, experiment_config, experiment_hash, experiment_name, experiment_id, datasetsplit_hash, embeddings_hash, embeddings_masked_hash):
    ...
    if any([datasetsplit_hash, embeddings_hash, embeddings_masked_hash]):
        ...
        from ssc4frames.newcli.helpers import get_hash_for_datasetsplit, get_hash_for_embeddings
